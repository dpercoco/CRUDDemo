...
// TODO finish the migration from "amx.*" to "adf.mf.api.amx.*" and "adf.mf.internal.amx.*"
  ...
  amx.createNumberConverter = function(tagInstance, label)
  {
    if (TrNumberConverter)
    {
      ...
      var negativePrefix = "";
      var negativeSuffix = "";
      var roundingMode = null; // future use, see TrNumberFormat.getRoundedValue

      var numberConverter = new TrNumberConverter(pattern, type, locale, messages,
        isDisabled, integerOnly, groupingUsed, currencyCode, currencySymbol,
        maxFractionDigits, maxIntegerDigits, minFractionDigits, minIntegerDigits,
        negativePrefix, negativeSuffix, roundingMode);
      var converter = {};
