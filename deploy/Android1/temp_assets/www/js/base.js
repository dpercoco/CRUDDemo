      ...
      adf.mf.api.resourceFile._loadFileWithAjax(
        ...
        function(responseText)
        {
          if ((responseText != null) && (responseText.length > 0))
          {
            ...
            {
              if (responseText.indexOf("404") != -1)
                problem = "Error 404 Not Found: \"" + resourceName + "\"";
              else
...
(function()
{
  ...
  adf.mf.internal.locale._convertToOracleCode = function(rawCode)
  {
    ...
    // - Norwegian nb --> no
    // - Norwegian for all regions nb-* --> no-*
    // - Hebrew he --> iw
    // - Hebrew for all regions: he-* --> iw-*
    if (oracleCode == "zh-Hans")
      ...
      oracleCode = "iw";
    else if (oracleCode.indexOf("he-") == 0)
      oracleCode = "iw-" + oracleCode.substring(3);
