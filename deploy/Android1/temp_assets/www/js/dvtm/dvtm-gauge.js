...
(function()
{
  ...
  {    
    ...
    var attrChanges = context['_attributeChanges'];
    if (attrChanges && attrChanges.hasChanged('value'))
    {
  ...
  BaseGaugeRenderer.prototype.ProcessEvent = function(amxNode, event, component)
  {
    BaseGaugeRenderer.superclass.ProcessEvent.call(this, amxNode, event, component);
...
(function(){
  ...
  DialGaugeRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.DialGauge');
  };
...
{  
  ...
  LedGaugeRenderer.prototype.ProcessEvent = function(amxNode, event, component)
  {
    // no events here
  }

  LedGaugeRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.LedGauge');
  };
...
(function(){
  ...
  RatingGaugeRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.RatingGauge');
  };
...
(function(){
  ...
  StatusMeterGaugeRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.StatusMeterGauge');
  };
