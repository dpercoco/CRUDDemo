...
(function()
{
  ...
  BaseChartRenderer.prototype.ProcessEvent = function(amxNode, event, component)
  {
    BaseChartRenderer.superclass.ProcessEvent.call(this, amxNode, event, component);
    var that = this;
   ...
   */
  BaseChartRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.Chart');
  };
...
(function()
{
   ...
   */
  SparkChartRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.SparkChart');
  };
...
(function ()
{
  ...
  StockDataItemRenderer.prototype.ProcessAttributes = function (options, markerNode, context)
  {
    ...
    var series = adf.mf.internal.dvt.chart.SeriesHelper.getSeriesByIdAndName(amxNode, seriesId, seriesName === null ? "" : seriesName);
    // by default use off to avoid bug in jet 2.0.2
    // TODO remove this in jet 2.1.0
    series['displayInLegend'] = 'off';
