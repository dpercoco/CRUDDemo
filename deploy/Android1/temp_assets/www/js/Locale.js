...
function _getPercentPositivePrefix()
{
  return this.getLocaleElements()["PercentElements"][2];
}

function _getPercentNegativePrefix()
{
  return this.getLocaleElements()["PercentElements"][3];
}

function _getPercentMaximumFractionDigits()
{
  return parseInt(this.getLocaleElements()["PercentElements"][4], 10);
}

function _getPercentMaximumIntegerDigits()
{
  return parseInt(this.getLocaleElements()["PercentElements"][5], 10);
}

function _getPercentMinimumFractionDigits()
{
  return parseInt(this.getLocaleElements()["PercentElements"][6], 10);
}

function _getPercentMinimumIntegerDigits()
{
  return parseInt(this.getLocaleElements()["PercentElements"][7], 10);
}
...
function _getDefaultFractionDigitsString()
{
  // aka _getCurrencyMaximumFractionDigits
  return this.getLocaleElements()["CurrencyElements"][6]; // can be "-1"
}

function _getCurrencyMaximumFractionDigits()
{
  return parseInt(this.getLocaleElements()["CurrencyElements"][6], 10); // can be -1
}

function _getCurrencyMinimumFractionDigits()
{
  return parseInt(this.getLocaleElements()["CurrencyElements"][7], 10); // can be -1
}
...
function _getFirstDayOfWeekNumber()
{
  // Corresponds to java.util.Calendar.SUNDAY ("1"), MONDAY ("2"), etc.
  var firstDayOfWeekString = this.getLocaleElements()["CalendarInfo"][0];
  var firstDayOfWeekNumber = parseInt(firstDayOfWeekString, 10);

  // Convert to 0 for Sunday, 1 for Monday, 2 for Tuesday, and so on. to match the
  // JavaScript spec.
...
function _getMinimalDaysInFirstWeekNumber()
{
  var minimalDaysInFirstWeekString = this.getLocaleElements()["CalendarInfo"][1];
  return parseInt(minimalDaysInFirstWeekString, 10);
}

function _getCalendarTypeString()
{
  return this.getLocaleElements()["CalendarInfo"][2]; // e.g. "gregory" or "buddhist"
}

function _isWeekDateSupported()
{
  return "true" == this.getLocaleElements()["CalendarInfo"][3];
}

window.LocaleSymbols = function(localeElements)
{
  // LocaleElements are generated from:
...
LocaleSymbols.prototype.getFirstDayOfWeekNumber = _getFirstDayOfWeekNumber;
LocaleSymbols.prototype.getMinimalDaysInFirstWeekNumber = _getMinimalDaysInFirstWeekNumber;
LocaleSymbols.prototype.getCalendarTypeString = _getCalendarTypeString;
LocaleSymbols.prototype.isWeekDateSupported = _isWeekDateSupported;
...
LocaleSymbols.prototype.getPercentPositivePrefix = _getPercentPositivePrefix;
LocaleSymbols.prototype.getPercentNegativePrefix = _getPercentNegativePrefix;
LocaleSymbols.prototype.getPercentMaximumFractionDigits = _getPercentMaximumFractionDigits;
LocaleSymbols.prototype.getPercentMaximumIntegerDigits = _getPercentMaximumIntegerDigits;
LocaleSymbols.prototype.getPercentMinimumFractionDigits = _getPercentMinimumFractionDigits;
LocaleSymbols.prototype.getPercentMinimumIntegerDigits = _getPercentMinimumIntegerDigits;
...
LocaleSymbols.prototype.getDefaultFractionDigitsString = _getDefaultFractionDigitsString;
LocaleSymbols.prototype.getCurrencyMaximumFractionDigits = _getCurrencyMaximumFractionDigits;
LocaleSymbols.prototype.getCurrencyMinimumFractionDigits = _getCurrencyMinimumFractionDigits;
