...
(function ()
{
  ...
  BaseTreeviewRenderer.prototype.ProcessEvent = function(amxNode, event, component)
  {
    BaseTreeviewRenderer.superclass.ProcessEvent.call(this, amxNode, event, component);
    var renderer = this;
...
(function(){
  ...
  SunburstRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.Sunburst');
  };
...
(function(){
  ...
  TreemapRenderer.prototype.GetToolkitClass = function()
  {
    return adf.mf.internal.dvt.util.JSONPath('adf.mf.internal.dvt.toolkit.Treemap');
  };
