// @compiled on Mon Nov 07 19:51:09 MST 2016
// Note: this is a generated file all changes will be lost. 


/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/application/NavigationHandlerImpl.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/application/NavigationHandlerImpl.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ControlFlowCaseXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ControlFlowCaseXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/UrlUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/UrlUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/TaskFlowCallActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/TaskFlowCallActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/ViewIdUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/ViewIdUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/engine/ControlFlowEngine.js///////////////////////////////////////
...
(function()
{
       ...
       if (routingState.getNavigationResult() == null)
       {
        ...
        if (backNav)
        {
             ...
             (!routingState.isBackNavTfPopped() && !currentTaskFlowEntry.peekViewHistory().isBackNavigationValid()))
          {
            ...
            //
            var currentViewItem1 = currentTaskFlowEntry.peekViewHistory();
            var navResult3 = ControlFlowEngine.constructBackNavResult(currentViewItem1, currentViewItem1);
            ControlFlowEngine.notifyEndNavigationListeners(routingState.getStartingViewId(), navResult3, routingState);
          ...
          else if (routingState.isBackNavTfPopped())
          {
             ...
             ControlFlowEngine.notifyEndNavigationListeners(routingState.getStartingViewId(), navResult, routingState);
          ...
          else
          {
            ...
            ControlFlowEngine.notifyEndNavigationListeners(routingState.getStartingViewId(), navResult1, routingState);
            (routingState.getRoutingSuccessCallback())(routingState.getNavigationResult());
          }
        }
        else
        {
          ...
          ControlFlowEngine.constructForwardNavResult(
            function(navResult2)
            {
              ...
              //
              ControlFlowEngine.notifyEndNavigationListeners(routingState.getStartingViewId(), 
                                                             routingState.getNavigationResult(),
                                                             routingState);
              (routingState.getRoutingSuccessCallback())(routingState.getNavigationResult());
            },
            routingState);
  ...
  ControlFlowEngine.constructBackNavResult = function(backFromViewItem, retunredToViewItem)
  {
    ...
    var newViewId = retunredToViewItem.viewId;
    var vdlDocPath = retunredToViewItem.amxPage;
    var transition = backFromViewItem.transitionType;
    var isDifferentViewId = (backFromViewItem.itemId != retunredToViewItem.itemId);
    var result = new adfc.NavigationResult(false, true, newViewId, vdlDocPath, transition, false, isDifferentViewId);
  ...
  ControlFlowEngine.constructForwardNavResult = function(callback, routingState)
  {
    ...
    {
      //
      //  In this case we have a final viewId because navigation went somewhere, either
      //  to a new view activity or returned to a calling task flow.
      //
    ...
    {
      //
      //  In this case navigation didn't go anywhere and did not produce a new
      //  viewId, we're still on the original view.
      //
      ControlFlowEngine._constructForwardNavResultPhase2(
        transition,
        currentTaskFlowEntry,
  ...
  {
    var perfCall = adf.mf.internal.perf.startMonitorCall("ExecuteActivity", adf.mf.log.level.FINE,
                                                         "ControlFlowEngine.executeActivity",
    ...
    var getBCPathSuccess = function(req, path)
    {
      ...
      if ((originalBindingPath != null) || (activityBindingPath != null))
      {
        ...
        //
        bcChanged = true;
        routingState.setBindingContainerChanged(true);
  ...
  ControlFlowEngine.notifyEndNavigationListeners = function(currentViewId, navigationResult, routingState)
  {
    ...
    //  If we are we might need to restore that view activity's context if non-view activities have
    //  set a different context.
    //
    if ((navigationResult != null) && !navigationResult.isDifferentViewId() && routingState.isBindingContainerChanged())
    {
      //
      //  Navigation did not reach a different view activity but the binding container was changed during
      //  navigation.  In this case we need to set that view's context again to restore the binding container.
      //
      var contextPath = adfc.internal.AdfcContext.getControllerState().peekTaskFlowStack().peekViewHistory().amxPage;
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/engine/ControlFlowEngine.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/IdUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/IdUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/ViewHistoryItem.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/ViewHistoryItem.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/TaskFlowReturnActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/TaskFlowReturnActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/metadata/MetadataService.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/metadata/MetadataService.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationHandler.js///////////////////////////////////////
...
(function(){
  ...
  {
      var perfOp = adf.mf.internal.perf.startMonitorOperation("getInitialViewId", adf.mf.log.level.FINE,
                                                              "NavigationHandler.getInitialViewId");

      if (adfc.internal.LogUtil.isFine())
      {
         adfc.internal.LogUtil.fine("ADFc: executing NavigationHandler.getInitialViewId() called.");
      }
  ...
  {
      var perfOp = adf.mf.internal.perf.startMonitorOperation("Navigation", adf.mf.log.level.FINE,
      ...
      if (adfc.internal.LogUtil.isFine())
      {
         adfc.internal.LogUtil.fine("ADFc: executing NavigationHandler.handleNavigation(), currentViewId=" + 
      ...
      var failed = function(message) 
      {
         ...
         if (adfc.internal.LogUtil.isFine())
         {
            adfc.internal.LogUtil.fine("ADFc: executing NavigationHandler.handleNavigation() failed");
         }
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationHandler.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/TaskFlowInputParameterXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/TaskFlowInputParameterXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/MetadataService.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/MetadataService.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/adf/mf/internal/controller/ViewHistory.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/adf/mf/internal/controller/ViewHistory.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowInputParameter.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowInputParameter.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowId.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowId.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/ViewActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/ViewActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ControlFlowRule.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ControlFlowRule.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowReturnActivity.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowReturnActivity.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ManagedBeanDefinition.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ManagedBeanDefinition.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ViewActivity.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ViewActivity.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/RouterCase.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/RouterCase.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ManagedPropertyDefinition.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ManagedPropertyDefinition.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/ActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/ActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/ElUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/ElUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/SystemUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/SystemUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/TaskFlowDefinitionXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/TaskFlowDefinitionXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/ControllerState.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/ControllerState.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/XmlUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/XmlUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/LogUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/LogUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/TaskFlowIdUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/TaskFlowIdUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/RouterActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/RouterActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ManagedBeanDefinitionXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ManagedBeanDefinitionXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationEvent.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationEvent.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ControlFlowRuleXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ControlFlowRuleXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ControlFlowCase.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ControlFlowCase.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/MethodCallActivityLogic.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/activity/MethodCallActivityLogic.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/MethodCallParameter.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/MethodCallParameter.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/MethodCallActivity.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/MethodCallActivity.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowCallParameter.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowCallParameter.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/RouterActivity.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/RouterActivity.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/TaskFlowStackEntry.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/TaskFlowStackEntry.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationResult.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/NavigationResult.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ActivityXmlParser.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/xml/ActivityXmlParser.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/AdfcContext.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/state/AdfcContext.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/Util.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adf/controller/Util.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/MsgUtil.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/util/MsgUtil.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ActivityId.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ActivityId.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ActivityType.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/ActivityType.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/engine/RoutingState.js///////////////////////////////////////
...
(function(){
   ...
   function RoutingState(startingTfInstanceId, startingViewId, currentActivityId, currentOutcome)
   {
      ...
      //  If back nav out of a TF has the TF been popped yet?
      this.mBackNavTfPopped = false;
      
      //  If back nav out of a TF the view item being left.
      this.mBackNavTfLeftViewItem = null;
      
      // Stack entry popped during the last TF return activity.
      this.mLastReturnedFromTfEntry = null;
      
      //  Was the binding container ever changed during navigation?
      this.mBindingContainerChanged = false;
   }
   ...
   RoutingState.prototype.setBindingContainerChanged = function(changed) 
   {
      this.mBindingContainerChanged = changed;
   }
   
   RoutingState.prototype.isBindingContainerChanged = function() 
   {
      return this.mBindingContainerChanged;
   }
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/engine/RoutingState.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowCallActivity.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowCallActivity.js///////////////////////////////////////



/////////////////////////////////////// start of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowDefinition.js///////////////////////////////////////
...
/////////////////////////////////////// end of /Volumes/MAF/JenkinsArchive/workspace/MAF-v2.3.3.0.0-And-iOS-Test/Container/JavaScript/Controller/js/oracle/adfinternal/controller/metadata/model/TaskFlowDefinition.js///////////////////////////////////////
